...
<p style="font-size: 5px;"></p><!--espaçamento-->
...
<p style="font-size: 20px;"></p><!--espaçamento-->
<div id="quadradobranco3">
    <div id="numero"> </div>
    <div id="Elemento"> </div>
</div><!---Rádio-->
